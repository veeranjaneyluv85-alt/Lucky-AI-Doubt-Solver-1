      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className="sticky top-0 z-40 bg-white/70 backdrop-blur-xl border-b border-slate-100 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl md:text-2xl font-black text-slate-900 tracking-tight leading-none">Lucky AI Doubt Solver – App Loaded Successfully</h1>
          ...
          <button 
            onClick={handleReset}
            className="p-3 bg-slate-100 text-slate-500 rounded-2xl hover:bg-rose-100 hover:text-rose-600 transition-all border border-transparent hover:border-rose-200"
          >
