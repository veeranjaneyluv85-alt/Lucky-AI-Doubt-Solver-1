          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-6 border-t border-slate-50">
             <div className="flex items-center gap-4 w-full md:w-auto">
               <button
                ...
                className="flex items-center gap-3 px-6 py-4 bg-slate-50 text-slate-600 rounded-2xl font-bold hover:bg-slate-100 transition-all active:scale-95 group/cam"
              >
                <CameraIcon className="w-6 h-6 text-violet-500 group-hover/cam:rotate-12 transition-transform" />
              ...
              {image && (
                <div className="relative h-14 w-14 group/img">
                  ...
                  <button 
                    ...
                    className="absolute -top-2 -right-2 w-6 h-6 bg-rose-500 text-white rounded-full flex items-center justify-center shadow-lg font-bold text-xs scale-0 group-hover/img:scale-100 transition-transform"
                  >
                    ×
                  </button>
                </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                <button
                  ...
                  className="bg-rose-600 text-white px-8 py-4 rounded-2xl font-black flex items-center justify-center gap-3 hover:bg-rose-700 transition-all shadow-lg active:scale-95"
                >
                  Watch Top Result
                </button>
                <button
                  onClick={() => openYouTube(false)}
                  className="bg-white text-slate-700 border-2 border-slate-200 px-8 py-4 rounded-2xl font-black flex items-center justify-center gap-3 hover:bg-slate-50 transition-all shadow-sm active:scale-95"
                >
                  Browse Channels
                </button>
              </div>
